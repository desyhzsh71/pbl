...
export async function getOrganizations(req: Request, res: Response) {
  try {
    ...
    // mengambil semua org dimana user adalah active member
    const where: any = {
      members: {
        some: {
          userId,
...
export async function getOrganizationById(req: Request, res: Response) {
  try {
    ...
    // mengambil organisasi hanya jika user adalah active member
    ...
    // mengambil role user di organization ini
...
export async function deleteOrganization(req: Request, res: Response) {
  try {
    ...
    // mengecek apakah masih ada project aktif
